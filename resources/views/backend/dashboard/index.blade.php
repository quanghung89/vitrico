...
@section('title', 'Vitrico')
@section('content.header', 'Bảng Điều Khiển')
@section('content.links.before', route('dashboard.index'))
@section('content.before', 'Bảng Điều Khiển')
@section('content.after', 'index')
@section('content')
    <!-- Main content -->
    <div class="invoice p-3 mb-3">
        ...
        <div class="row">
            <div class="col-12">
                <h4>
                    <i class="fas fa-globe"></i> Du Học Vitrico
